  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-400 mt-2">AI-driven readiness assessments for debt, equity, and grants.</p>
      </div>
      ...
      <Card className="p-12 bg-slate-900 border-slate-800 flex flex-col items-center justify-center text-center">
        ...
        <p className="text-slate-400 max-w-md">
          The Advanced Funding Readiness module is natively integrated with your Unified Entrepreneur Context. Data flows bidirectionally from PostgreSQL to the AI Gateway.
        </p>
      </Card>
    </div>
  );

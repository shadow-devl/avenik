  ...
  return (
    <div className="min-h-screen bg-slate-950">
      ...
      <main className="mx-auto max-w-4xl px-6 py-12">
        <h1 className="text-2xl font-semibold text-white">Sustainability</h1>
        ...
        <div className="mt-8 rounded-xl border border-slate-800 bg-slate-900/50 p-12 text-center">
          ...
          <p className="mt-2 text-sm text-slate-400">The Sustainability functionality has been scaffolded and is ready for data integration.</p>
        </div>
      </main>
    </div>
  );

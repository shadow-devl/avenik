...
export default function EcosystemOpportunityPortfolioIntelligencePage() {
  return (
    <div className="min-h-screen bg-slate-950">
      ...
      <main className="mx-auto max-w-4xl px-6 py-12">
        <h1 className="text-2xl font-semibold text-white">Ecosystem Opportunity Portfolio Intelligence</h1>

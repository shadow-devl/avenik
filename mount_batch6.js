...
const modules = [
  { name: 'cybersecurityRouter', file: './routes/cybersecurity.js', path: '/api/cybersecurity' },
  { name: 'internationalizationRouter', file: './routes/internationalization.js', path: '/api/internationalization' },
  { name: 'supportPortfolioRouter', file: './routes/government-support-portfolio.js', path: '/api/government-support-portfolio' },
];
...
console.log('Mounted Batch 6 Routes.');
